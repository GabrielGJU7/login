         ...
         <div x-show.transition="step === 'complete'">
             <div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
                 <div>
                     ...
                     <h2 class="text-2xl mb-4 text-gray-800 text-center font-bold">Guardado correctamente</h2>

                     <div class="text-gray-600 mb-8">
                         Gracias, Todos los datos almacenados en el formulario fueron llenados de manera satisfactoria.
                     </div>
                    <a 
                    href="alumnos.php"
         ...
         <div x-show.transition="step != 'complete'">	
             ...
             <div class="border-b-2 py-4">
                 ...
                 <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                     <div class="flex-1">
                         <div x-show="step === 1">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Informacion Personal</div>
                         </div>
                         
                         <div x-show="step === 2">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Academicos</div>
                         </div>

                         <div x-show="step === 3">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Adicional</div>
                         </div>
                     </div>
             ...
             <div class="py-10">	
                 <div x-show.transition.in="step === 1">
                     <div class="mb-5 text-center">
                         ...
                         <div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Click para seleccionar foto</div>
                     ...
                     <div class="mb-5">
                         <label for="email" class="font-bold mb-1 text-gray-700 block">Apellidos</label>
                         <input type="text"
                             class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                             placeholder="Ingresa tus apellidos...">
                     </div>
                     <div class="mb-5">
                         <label for="email" class="font-bold mb-1 text-gray-700 block">CURP/RUC/ITIN/SOCIAL</label>
                         <input type="text"
                             class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                 ...
                 <div x-show.transition.in="step === 2">
                     ...
                     <div class="mb-5">
                         <label for="password" class="font-bold mb-1 text-gray-700 block">Ingresa tus datos academicos</label>
                         <div class="text-gray-600 mt-2 mb-4">
                             Por favor ingresa los datos proporcionados por tu CTC.
                        </div>

                         <div class="relative">
                            <div class="mb-5">
                            <label for="email" class="font-bold mb-1 text-gray-700 block">Matricula</label>
                            <input type="text"
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                placeholder="Ingresa Matricula...">
                                <div class="mb-5">
                            <label for="email" class="font-bold mb-1 text-gray-700 block">Titulo</label>
                            <input type="text"
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                placeholder="Ingresa Titulo...">
                            </div>
                            <div class="mb-5">
                            <label for="email" class="font-bold mb-1 text-gray-700 block">CTC</label>
                            <input type="text"
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                placeholder="Ingresa CTC...">
                            </div>
                            </div>
                         </div>
                 </div>
                 ...
                 <div x-show.transition.in="step === 3">
                     <div class="mb-5">
                         <label for="email" class="font-bold mb-1 text-gray-700 block">Genero</label>
                         ...
                         <div class="flex">
                             <label
                                 ...
                                 <div class="select-none text-gray-700">Hombre</div>
                             </label>
                             ...
                             <label
                                 ...
                                 <div class="select-none text-gray-700">Mujer</div>
                             </label>
                         </div>
                     </div>
                 </div>

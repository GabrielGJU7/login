        ...
        <div class="bg-white w-2/3 mt-10 rounded-lg">
            ...
            <div class="flex justify-between p-4">
                ...
                <div class="flex items-center justify-center mt-3 mb-6 flex-col">
                    ...
                    <div class="flex mt-2">
                        <button class="text-xs text-red-500 border-2 py-1 px-2 border-red-500 p-1 mr-3 h-10 w-20">CONOCER</button>
                        <button class="text-xs text-blue-600 border-2 py-1 px-2 border-yellow-500 p-1 mr-3 h-10 w-20">O*NET</button>
                        <button class="text-xs text-blue-600 border-2 py-1 px-2 border-blue-600 p-1 mr-3 h-10 w-20">ESCO</button>
                    </div>
                </div>
                <div class="flex items-center justify-center mt-3 mb-6 flex-col">

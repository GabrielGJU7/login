...
<head>
    ...
    <title><?php echo $_SESSION['Nombre'] . ' ' .$_SESSION['apellido'] ?></title>
</head>
<body>
    ...
    <div class="flex item-center justify-center">
        <div class="bg-white w-2/3 mt-10 rounded-lg">
            ...
            <div class="flex justify-between p-4">
                <div>
                    <h1 class="text-xs uppercase text-gray-500 mb-3"><?php echo $_SESSION['matricula']  ?></h1>
